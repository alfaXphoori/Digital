...
## ส่วนที่ 5: ท้าทาย — ยุบวงจรลงในชิปโปรแกรมได้ (Optional / Bonus) ⭐

ในงานวิศวกรรมจริง วงจรแบบนี้ไม่ได้ต่อด้วยไอซีแยกตัวแล้ว แต่ถูกยุบรวมลงในชิปตัวเดียวที่โปรแกรมได้ (ทบทวนบทที่ 8)

**คำถาม:**
1. **แทนตัวถอดรหัสด้วย ROM:** ถ้าต้องการแทนไอซี 4511 ด้วย ROM จะต้องใช้ ROM ขนาดกี่บิต?
   - [ ] $16 \times 7$ บิต
   - [ ] $10 \times 4$ บิต
2. **ยุบทั้งวงจรลงใน PLD:** ถ้าต้องการยุบทั้งตัวนับและตัวถอดรหัสลงในชิปเดียว ควรเลือกอุปกรณ์ชนิดใด?
   - [ ] PAL แบบคอมบิเนชันล้วน (ไม่มีฟลิปฟลอป)
   - [ ] Registered PAL หรือ CPLD (มีฟลิปฟลอปและเส้น feedback)
3. **เหตุผล:** จงอธิบายสั้น ๆ ว่าทำไมคำตอบข้อ 2 จึงต้องเป็นอุปกรณ์ที่มีฟลิปฟลอป
