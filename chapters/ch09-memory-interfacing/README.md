...
> 💡 ความจุของวงจรนี้ = $2^2$ Address × 4 bit = **16 บิต (2 ไบต์)** ตามสูตรในหัวข้อ 9.2 — สังเกตว่าถ้าเพิ่มเส้น Address เพียง 1 เส้น จำนวนแถวและจำนวนเซลล์จะเพิ่มเป็น 2 เท่าทันที
...
> 💡 โครงสร้าง **Decoder + OR Array** นี้มีรากเดียวกับ PLA และ PROM ในหัวข้อ 9.7 ต่างกันที่ ROM ใช้ AND Array แบบตายตัว (ถอดรหัสครบทุก Minterm) ส่วน PLA โปรแกรมได้ทั้ง AND Array และ OR Array
