...
## 9.6 Testbench: การทดสอบวงจรอัตโนมัติ
...
## 9.7 การจำลองด้วย EDA Playground
...
## 9.8 เชื่อมโยงสิ่งที่เรียนมาทั้งหมดเข้ากับ HDL
...
| FSM | สัปดาห์ที่ 12 / Lab 12 | `always` สองบล็อก (state register + next-state logic) ด้วย `case` |
...
## 9.9 ข้อผิดพลาดที่พบบ่อยของผู้เริ่มต้น
...
5. ออกแบบ FSM ตรวจจับลำดับ "101" เป็น Verilog โดยใช้ `always` สองบล็อก พร้อม testbench ทดสอบสตรีมอินพุต
