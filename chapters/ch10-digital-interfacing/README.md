...
การนำสัญญาณแอนะล็อกมาประมวลผลและแสดงผลเป็นตัวเลข

**หลักการทำงาน:**
1. **Sensor (LM35):** เปลี่ยนอุณหภูมิเป็นแรงดัน (10mV/°C เช่น 25°C = 0.25V)
2. **ADC:** แปลงแรงดัน 0.25V เป็นรหัสฐานสอง (เช่น 8-bit ADC ให้ค่า 0–255)
3. **Processor:** คำนวณรหัสฐานสองกลับเป็นตัวเลข (25)
4. **Display:** ส่งรหัส BCD ไปยังไอซี **4511** เพื่อแสดงผลบน **7-Segment**

### 10.8.2 ระบบควบคุมความเร็วมอเตอร์ (PWM Speed Control)
การควบคุมความเร็วโดยไม่ต้องใช้ DAC จริง แต่ใช้การสลับสัญญาณดิจิทัล

**หลักการทำงาน:**
1. **Processor:** สร้างสัญญาณ PWM ที่มีความถี่คงที่ (เช่น 1kHz)
2. **Duty Cycle:** 
   - ตั้งเป็น 50% → มอเตอร์หมุนความเร็วปานกลาง
   - ตั้งเป็น 100% → มอเตอร์หมุนความเร็วสูงสุด
3. **Motor Driver:** รับสัญญาณ PWM ไปขับกระแสสูงเพื่อหมุนมอเตอร์ DC
